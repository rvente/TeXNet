...
% TODO: summarize architecture evolution
...
\begin{figure}[h]
	...
	\begin{subfigure}{1.0\textwidth}
		...
		\caption{}
	\end{subfigure}
  \caption[Model]{This assessment is on the validation set $N=1,652$. (a) The mean length
...
% TODO: finish
%lstm / variational autoencoder for infinite examples
%gru for faster training and deepermodels
%go deeper: cite the other references 
