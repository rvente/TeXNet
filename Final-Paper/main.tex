...
and \parencite{deng2016you}, the bigram \BLEU{} (\BLEU{}2) score computed with $w_1=w_2=.5$
...
sequence. Despite this, the \BLEU{}2 scores are satisfactory.

\subsection{Limitations and Future work}

% TODO: finish we know that performance suffers with long length, but is that
% because of too low resolution? if so take an image and just split it ∘ lstm /
% variational autoencoder for infinite examples ∘ gru for faster training and
% deepermodels go deeper: cite the other references who do better than us
...
\begin{figure}[!h]
  ...
  \end{lstlisting}
   \cprotect\caption{From \texttt{arXiv:1801.07684} \citeauthor{benedetti2018combinatorial} 
...
the last \verb|$| of the first line matched with the first \verb|$| of the 4th
line.}\label{falsematch}
\end{figure}
